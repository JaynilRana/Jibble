          ...
          {report.personal_insights && (
            <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    {report.personal_insights.suggestions.map((suggestion, index) => (
                      <div key={index} className="flex items-start gap-3">
                        ...
                        <p className="text-black-900 dark:text-black-100 leading-relaxed">
                          {suggestion}
                        </p>
                      </div>
                    ))}
              ...
              {report.personal_insights.positives && report.personal_insights.positives.length > 0 && (
                <div className={`p-6 rounded-lg ${isDark ? 'bg-green-900/20 border-green-700' : 'bg-green-50 border-green-200'} shadow-lg border`}>
              ...
              {report.personal_insights.negatives && report.personal_insights.negatives.length > 0 && (
                <div className={`p-6 rounded-lg ${isDark ? 'bg-orange-900/20 border-orange-700' : 'bg-orange-50 border-orange-200'} shadow-lg border`}>
