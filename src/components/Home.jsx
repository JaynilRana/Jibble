...
const Home = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <div id="home-section" className={`relative overflow-hidden ${
        isDark 
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div data-reveal className={`w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold mx-auto mb-4 ${
              ...
              <p data-reveal className={`journal-body ${
                isDark ? 'text-gray-300' : 'text-gray-600'
              }`}>
